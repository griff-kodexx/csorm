...
public class Database{
	...
	protected DBCollection connectDB(){
        ...
        protected void closeConnection(){
            //this.mongoClient.close(); //could it kill all the unnecessary connections?
            basicDBObject = null;
            mongoClient.close();
        }
        ...
        protected boolean login(final String submittedUsername, final String submittedpassword){
            ...
            try {
                ...
                Logger.getLogger(Database.class.getName()).log(Level.SEVERE, null, ex); //say whaaaat?
            }
            }
            ...
            this.mongoClient.close(); //kill connection to database and return authentication flag
            return flag;
        }
